...
export class DeepDiveSectionFront implements OnInit, OnChanges {
  @Input() scope: string;
  @Input() geoLocation: string;
  @Input() category:string;
  @Input() deepDiveType:string;
  ...
  getDeepDiveVideo(){
      this._deepDiveData.getDeepDiveVideoBatchService(this.scope, this.videoCallLimit, this.blockIndex, this.geoLocation).subscribe(
        data => {
          if(data != null){
